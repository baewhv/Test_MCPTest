...
3. **특정 작업 지정 착수 ("[작업명/키워드] 작업들 진행해줘", "[작업명] 진행해줘")**:
   - `docs/work/worklist.md`에서 해당 키워드와 일치하는 미완료 작업 목록을 탐색한다.
   - 사용자에게 "지정하신 작업([작업 목록])이 맞습니까? 작업을 시작할까요?"라고 확인 질문을 던지고, 사용자의 승인을 받은 후 착수한다.
