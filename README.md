...
| **`Developer`** | C# 코딩, 프리미티브 더미 조립, Search API 금지/보류, CLI 사전검수 | `unity_coding_rule.md, unity_work_rule.md`, `unity-cli-runner` | `PF_*.prefab`, `docs/ARCHITECTURE.md` |
...
│   ├── rules/              # 5대 표준 규칙 (unity_coding, unity_work, git, unity_folder, asset_generation)
